"""
Lightweight config client to fetch centralized config from backend
and cache it locally for short periods. Falls back to env vars if unreachable.
"""
...
def _fetch_config_from_backend() -> Dict[str, Any]:
