...
def test_materialize_canonical_relationships_smoke():
    ...
    url = f"{host}/api/graphs/projects/{project}/maintenance/materialize-canonical-relationships?min_support=2&max_pairs=50"
